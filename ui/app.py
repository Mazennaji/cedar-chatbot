...
<style>
    ...
    @keyframes borderGlow { 0%,100% { border-color: rgba(201,168,76,0.2); } 50% { border-color: rgba(201,168,76,0.45); } }
    ...
    div[data-testid="stSidebarCollapsedControl"] button {
        ...
        box-shadow: 4px 0 20px rgba(0,0,0,0.6), 0 0 14px rgba(201,168,76,0.15) !important;
        opacity: 1 !important;
